...
func ValidateBidSignature(bid *epbs.BuilderBid, builderAddr types.Address, commitment types.Hash) error {
	if bid == nil {
...
func ComputeBidCommitment(bid *epbs.BuilderBid, builderAddr types.Address) types.Hash {
	bidHash := bid.BidHash()
...
func (s *BidScorer) ScoreBid(bid *epbs.BuilderBid, reputation *BuilderReputation) float64 {
...
func FullBidValidation(
	...
	signed := &epbs.SignedBuilderBid{Message: *bid}
