...
func (n *NonDeliverySlashing) Check(bid *epbs.BuilderBid, payload *epbs.PayloadEnvelope) (bool, string) {
	if bid == nil {
		return false, ""
	}
...
func (ip *InvalidPayloadSlashing) Check(bid *epbs.BuilderBid, payload *epbs.PayloadEnvelope) (bool, string) {
...
type EquivocationEvidence struct {
	BidA *epbs.BuilderBid
	BidB *epbs.BuilderBid
}
...
func (e *EquivocationSlashing) Check(bid *epbs.BuilderBid, _ *epbs.PayloadEnvelope) (bool, string) {
...
type SlashingRecord struct {
	BuilderIndex  epbs.BuilderIndex     `json:"builderIndex"`
...
func ComputeEvidenceHash(condType SlashingConditionType, bid *epbs.BuilderBid, builderAddr types.Address) types.Hash {
	if bid == nil {
		return types.Hash{}
	}
	bidHash := bid.BidHash()
