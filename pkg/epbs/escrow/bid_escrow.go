...
// is allowed.
func (be *BidEscrow) PlaceBid(bid *epbs.BuilderBid) error {
	if bid == nil {
...
func (be *BidEscrow) RevealPayload(slot uint64, builderID string, payload *epbs.PayloadEnvelope) error {
	if payload == nil {
...
func (be *BidEscrow) GetBid(slot uint64) *epbs.BuilderBid {
	be.mu.RLock()
	defer be.mu.RUnlock()
