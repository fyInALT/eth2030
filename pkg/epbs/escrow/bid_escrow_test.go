...
func makeBidForEscrow(slot uint64, builderIdx epbs.BuilderIndex, value uint64) *epbs.BuilderBid {
	return &epbs.BuilderBid{
		Slot:            slot,
...
func makePayloadForEscrow(bid *epbs.BuilderBid) *epbs.PayloadEnvelope {
