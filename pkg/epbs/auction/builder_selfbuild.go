...
const (
	...
	BuilderIndexSelfBuild epbs.BuilderIndex = epbs.BuilderIndex(^uint64(0))
...
func (e *AuctionEngine) ProcessBidWithSelfBuild(bid *epbs.BuilderBid) (winner epbs.BuilderIndex, skipped bool) {
