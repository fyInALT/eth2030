...
func TestRegistryBidValidationTable(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "zero value",
			bid: &MarketBid{
				Bid: epbs.BuilderBid{Slot: 1, Value: 0, BlockHash: registryHash(0xAA), ParentBlockHash: registryHash(0xBB)},
			},
		...
		},
		{
			name: "zero slot",
			bid: &MarketBid{
				Bid: epbs.BuilderBid{Slot: 0, Value: 500, BlockHash: registryHash(0xAA), ParentBlockHash: registryHash(0xBB)},
			},
		...
		},
		{
			...
			bid: &MarketBid{
				Bid: epbs.BuilderBid{Slot: 1, Value: 500, BlockHash: types.Hash{}, ParentBlockHash: registryHash(0xBB)},
			},
		...
		},
		{
			...
			bid: &MarketBid{
				Bid: epbs.BuilderBid{Slot: 1, Value: 500, BlockHash: registryHash(0xAA), ParentBlockHash: types.Hash{}},
			},
		...
		},
		{
			...
			bid: &MarketBid{
				Bid: epbs.BuilderBid{Slot: 1, Value: 50, BlockHash: registryHash(0xAA), ParentBlockHash: registryHash(0xBB)},
			},
