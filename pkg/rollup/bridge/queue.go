// queue.go implements a queue-based deposit processing pipeline for the
// L1-L2 state bridge in native rollups (EIP-8079).
package bridge
...
// the given L2 block. Ready deposits are marked as Processed.
...
// VerifyWithdrawal verifies an L2->L1 withdrawal proof.
...
// GetDepositRoot returns the merkle root of all pending and processed deposits.
