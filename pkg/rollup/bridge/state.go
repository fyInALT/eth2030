...
// state.go provides deposit/withdrawal message encoding, withdrawal proof
// construction, state commitment derivation, and deposit tracking.
package bridge
...
// StateCommitment represents a cross-chain state commitment binding L1 and L2.
...
// DepositTracker records and queries L1->L2 deposit messages. Thread-safe.
