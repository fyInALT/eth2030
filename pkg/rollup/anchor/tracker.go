// tracker.go tracks per-chain anchor state for native rollups (EIP-8079).
// It maintains a registry of L2 chains with their anchor configurations,
// stores anchor history, handles confirmations, and provides per-chain metrics.
package anchor
