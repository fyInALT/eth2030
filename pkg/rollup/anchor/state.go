// Package anchor implements the anchor predeploy and state management for
// native rollups (EIP-8079). It manages L1->L2 anchoring via a ring buffer,
// multi-rollup anchor state tracking, and per-chain confirmation tracking.
package anchor
