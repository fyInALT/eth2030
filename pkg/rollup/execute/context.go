// context.go implements the execution context for the EXECUTE precompile in
// native rollups (EIP-8079). It manages gas metering, nested execution depth
// tracking, and result verification for cross-rollup calls.
package execute
...
// PrecompileAddr is the sentinel address for the EXECUTE precompile
// as defined in EIP-8079. Calls to this address trigger cross-rollup execution.
const PrecompileAddr = "0x0100000000000000000000000000000000000100"
...
// ContextConfig configures the execution context.
...
func NewExecutionContext(rollupID uint64, gasBudget uint64, config ContextConfig) *ExecutionContext {
