...
func TestE2EEIP1559GasPricing(t *testing.T) {
	...
	builder2 := core.NewBlockBuilder(coreconfig.TestConfig, nil, nil)
	...
	builder3 := core.NewBlockBuilder(coreconfig.TestConfig, nil, nil)
...
func TestE2EParallelExecution(t *testing.T) {
	...
	seqBuilder := core.NewBlockBuilder(coreconfig.TestConfig, nil, nil)
	...
	parBuilder := core.NewBlockBuilder(coreconfig.TestConfig, nil, nil)
