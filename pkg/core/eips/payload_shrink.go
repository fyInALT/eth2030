// Package eips implements EIP-specific execution layer logic.
// payload_shrink.go provides payload shrinking for reducing execution payload
// size on the wire. Part of the EL sustainability track (Hogota+ upgrades).
package eips
