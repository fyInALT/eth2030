...
// ValidateCalldataGasFields validates the EIP-7706 calldata gas header fields.
...
func NewMultidimGasPool(limits GasDimensions) *MultidimGasPool {
	computePool := new(gaspool.GasPool).AddGas(limits.Compute)
