...
func TestValidateCalldataGasFields(t *testing.T) {
	...
	if err := ValidateCalldataGasFields(child, parent); err != nil {
		t.Fatalf("ValidateCalldataGasFields failed for valid header: %v", err)
	}
	...
	if err := ValidateCalldataGasFields(childMissing, parent); err == nil {
	...
	if err := ValidateCalldataGasFields(childMissing2, parent); err == nil {
	...
	if err := ValidateCalldataGasFields(childOverLimit, parent); err == nil {
	...
	if err := ValidateCalldataGasFields(childWrongExcess, parent); err == nil {
