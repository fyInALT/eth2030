...
type OverlayTrie struct {
	...
	old    *mpt.Trie // read-only source (MPT)
	new_   *mpt.Trie // write target (new state)
...
func (o *OverlayTrie) OldTrie() *mpt.Trie {
	return o.old
}

// NewTrie returns the new (write) trie.
func (o *OverlayTrie) NewTrie() *mpt.Trie {
	return o.new_
}
