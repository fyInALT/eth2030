...
export const metadata: Metadata = {
  ...
  description:
    'Experimental Ethereum execution client targeting the L1 Strawmap (strawmap.org). 48 packages, 18,257+ tests, 58 EIPs, 100% EF state test conformance. Built in Go.',
  keywords: [
  ...
  openGraph: {
    title: 'ETH2030 — Ethereum Client for the L1 Strawmap',
    description:
      '48 packages, 18,257+ tests, 58 EIPs, 713K LOC. Full EVM, PQ crypto, native rollups, zkVM, 3SF, PeerDAS, ePBS.',
    siteName: 'ETH2030',
  ...
  twitter: {
    ...
    title: 'ETH2030 — Ethereum Client for the L1 Strawmap',
    description: '48 packages, 18,257+ tests, 58 EIPs, 713K LOC.',
    images: ['/og-image.png'],
  },
